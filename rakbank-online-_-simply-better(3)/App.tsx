  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (loginEmail === 'adam.smith@example.com' && loginPassword === '123456') {
      ...
      setTimeout(() => {
        ...
        setIsLoading(false);
        setAssistantMessages([{ role: 'assistant', text: `Marhaba, ${user.name.split(' ')[0]}. I'm your RAKBANK Digital Assistant. How can I help you manage your Elite account today?` }]);
      }, 1000);
    } else {
